...
short actionList()
{
    ...
    printf("\n\t\t\t\b\b#############################################################\n\
			...
			* 8  -Destroy hashTable\n\
            * 9  -Show number of data loaded into Hash-Table\n\
			*    \
			*                    \n\
    ...
    {
        printf("Printing number of entries loaded into hash table...\n");
    }
    else if(choice == 10){
...
double calculate(const struct rusage *b, const struct rusage *a)
{
    ...
    {
        return ((((a->ru_utime.tv_sec * 1000000 + a->ru_utime.tv_usec) - (b->ru_utime.tv_sec * 1000000 + b->ru_utime.tv_usec)) + ((a->ru_stime.tv_sec * 1000000 + a->ru_stime.tv_usec) -
...
/*
 * Prints usage of dic_hashTable driver program
 */
void usage(){
    printf("DIC_HASHTABLE(1) \t\t\tUser Commands\t\t\t\t\n\n"
           "NAME\n"
           "\t\t./dic_hashTable\t-create a dynamic hash table and load data into it\n"
           "SYNOPSIS\n"
           "\t\t ./dic_hashTable\n"
